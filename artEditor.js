/**
 * 移动端富文本编辑器(依赖zepto.js)
 * @author ganzw@gmail.com
 * @url    https://github.com/baixuexiyang/artEditor
 * @modifier sanny31@gmail.com
 * @url    https://github.com/sanny31/artEditor/
 */
(function ($) {
    $.extend($.fn, {
        _opt: {
            placeholder: '<p>请输入文章正文内容</p>',
            validHtml: [],
            limitSize: 3,
            showServer: false
        },
        ...
        upload: function (data) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var src = _this._opt.uploadSuccess(data);
                    if (src) {
                        var img = '<img src="' + src + '" style="width:90%;" />';
                        _this.insertImage(img);
                    } else {
                        _this._opt.uploadError(data);
                    }
                },
